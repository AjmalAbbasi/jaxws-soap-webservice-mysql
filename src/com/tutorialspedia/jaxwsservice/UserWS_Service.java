 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://tutorialspedia.com/UserWS/", wsdlLocation = "file:/C:/Users/admin/eclipse-workspace/JAXWSSoapWebServiceTutorial/UserWS.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://tutorialspedia.com/UserWS/", "UserWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/admin/eclipse-workspace/JAXWSSoapWebServiceTutorial/UserWS.wsdl");
    ...
    public UserWS getUserWSSOAP() {
        return super.getPort(new QName("http://tutorialspedia.com/UserWS/", "UserWSSOAP"), UserWS.class);
    }
    ...
    public UserWS getUserWSSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://tutorialspedia.com/UserWS/", "UserWSSOAP"), UserWS.class, features);
    }
